...
export default class PagoConfirm extends Component{
    constructor(){
        super()
    }
    
    mensaje(){
        if(this.props.pay==='no'){
            return(
                <Text style={{fontSize:20}}>No ha seleccionado un metodo de pago </Text>
            )
        }
        else if(this.props.pay==='insuficent'){
            return(
                <Text style={{fontSize:20}}>No posee saldo suficiente para realizar el viaje </Text>
            )
        }
    }
