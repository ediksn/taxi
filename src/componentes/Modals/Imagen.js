...
import { Modal, Platform,View, Dimensions, StyleSheet, Image} from "react-native";
            ...
            >
                ...
                <View style={{justifyContent:'center', flexDirection:'column'}}>
                    ...
                    <View style={estilo.botones}>
                        ...
                        >
                            <Text style={{textAlign:'center', width:ancho*0.4}}>Tomar foto</Text>
                        </Button>
                        <Button
                            rounded
                            dark
                            ...
                            style={estilo.boton_1}
                        >
                            <Text style={{textAlign:'center', width:ancho*0.4}}>Seleccionar</Text>
                        </Button>
                    </View>
                </View>
