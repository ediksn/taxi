...
import { View, Platform,StyleSheet, Dimensions, Image,TouchableHighlight } from 'react-native'
            ...
            <View style={style.view}>
                <Card style={style.fondo}>
                    ...
                    {/*<View style={style.botones}>
                        <TouchableHighlight underlayColor={'transparent'} onPress={()=>{this.iniciar()}}>
                            <Button 
